...
from ._bzr_rs.lru_cache import LRUSizeCache  # noqa: F401
...
# LRUSizeCache is implemented as a Rust pyclass (re-exported at the top of
# this module). It evicts entries based on the cumulative size of the values
# (compute_size(value), defaulting to len); the ordering/eviction engine
# lives in the bazaar crate.
