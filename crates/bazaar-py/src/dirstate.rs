...
pyo3::import_exception!(bzrformats._bzr_rs.errors, NotVersionedError);
pyo3::import_exception!(bzrformats._bzr_rs.errors, BzrFormatsError);
pyo3::import_exception!(bzrformats._bzr_rs.errors, InconsistentDelta);
pyo3::import_exception!(bzrformats._bzr_rs.errors, InvalidNormalization);
pyo3::import_exception!(bzrformats._bzr_rs.errors, BadFileKindError);
pyo3::import_exception!(bzrformats._bzr_rs.errors, LockContention);
pyo3::import_exception!(bzrformats._bzr_rs.errors, LockNotHeld);
